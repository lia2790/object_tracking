...
int main(int argc, char **argv) 
{
	...
	ros::NodeHandle n = ros::NodeHandle("ObjectTracker");
	ros::Rate loop_rate(100);
	ros::ServiceServer Start_serv = n.advertiseService("Start",startTrack);
	ros::ServiceServer Stop_serv  = n.advertiseService("Stop",stopTrack);
	...
	vreader >> Image;//take a first image 	
	
	Ob_track.setValue(argv[1], atof(argv[2]), Image);//preload size marker, camera parameters 
